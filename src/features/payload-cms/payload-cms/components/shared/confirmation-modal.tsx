...
export const ConfirmationModal: React.FC<{
  ...
  const modalContent = (
    <div className="z-900 fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-[2px]">
        ...
        <div className="flex justify-end gap-3">
          {!hideCancel && (
            <button
              ...
              className="cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
            >
