  ...
  return (
    <div className="mb-4">
      <div className="flex items-start">
        <input
          id={name}
          className={`text-conveniat-green mt-[3px] h-4 w-4 rounded border-0 bg-green-100 shadow-sm ring-1 ring-inset ${hasError ? 'ring-red-500' : 'ring-transparent'} focus:ring-conveniat-green transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0`}
          type="checkbox"
          {...registerAction(name, {
        ...
        <label
          className="ml-2 min-w-0 flex-1 hyphens-auto break-words font-['Inter'] text-sm font-medium text-gray-500 hover:text-gray-900 [&_div]:inline [&_p]:inline"
          htmlFor={name}
          lang={locale}
        >
