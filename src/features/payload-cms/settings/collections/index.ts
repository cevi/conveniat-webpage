...
import { BlogArticleCollection } from '@/features/payload-cms/settings/collections/blog-article';
import { GenericPage as GenericPageCollection } from '@/features/payload-cms/settings/collections/generic-page';
import { TimelineCollection } from '@/features/payload-cms/settings/collections/timeline';
import { ImageCollection } from '@/features/payload-cms/settings/collections/image-collection';
import { DocumentsCollection } from '@/features/payload-cms/settings/collections/documents-collection';
import { UserCollection } from '@/features/payload-cms/settings/collections/user-collection';
import { PermissionsCollection } from '@/features/payload-cms/settings/collections/permission-collection';
import { PushNotificationSubscriptions } from '@/features/payload-cms/settings/collections/push-notification-subscriptions';
