import { locales as localesDefinition } from '@/features/payload-cms/settings/locales';
import type { Locale } from 'payload';
import type { Config } from '@/features/payload-cms/payload-types';
import { useEffect, useState } from 'react';
import type { Locale as LocaleType } from '@/types/types';
import { useLocalizedDocument } from '@/features/payload-cms/settings/hooks/localized-document';
