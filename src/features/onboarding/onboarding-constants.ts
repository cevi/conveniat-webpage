...
export const cookieInfoText: StaticTranslationString = {
  ...
  fr: 'Nous utilisons des cookies pour vous offrir la meilleure expérience possible sur notre application.',
};

export const acceptCookiesText: StaticTranslationString = {
  en: 'Accept Cookies',
