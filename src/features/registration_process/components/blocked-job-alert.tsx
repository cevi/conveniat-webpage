...
const BlockedJobRow: React.FC<{
  ...
  return (
    <>
      <tr className="dark:hover:bg-white/2 group border-b border-zinc-100 bg-white transition-colors hover:bg-zinc-50/50 dark:border-zinc-800 dark:bg-transparent">
        <td className="py-5 pl-0 pr-4 align-top">
        ...
        <td className="px-4 py-5 align-top">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="cursor-pointer text-[11px] font-black uppercase tracking-widest text-orange-600 transition-all hover:text-orange-800 disabled:opacity-30 dark:text-orange-500 dark:hover:text-orange-400"
            >
        ...
        <td className="px-4 py-5 text-right align-top">
          <button
            ...
            className="cursor-pointer text-[10px] font-black uppercase tracking-wider text-zinc-400 transition-colors hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white"
          >
      ...
      {isExpanded && (
        <tr className="animate-in fade-in slide-in-from-top-1 duration-200">
          <td colSpan={3} className="dark:bg-white/1 bg-zinc-50/30 py-4 pl-0 pr-0">
            <div className="flex gap-3">
              ...
              <div className="relative grow rounded-xl border border-zinc-100 bg-white p-4 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/50">
                <code className="block whitespace-pre-wrap font-mono text-[11px] leading-relaxed text-zinc-500 dark:text-zinc-400">
  ...
  return (
    <div className="flex flex-col gap-6 border-l-4 border-orange-500 py-2 pl-8 dark:border-orange-600">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-base font-black uppercase tracking-tight text-zinc-900 dark:text-white">
          Attention Required
        </h2>
        <span className="rounded-full bg-orange-100 px-3 py-1 text-[11px] font-black uppercase text-orange-700 dark:bg-orange-500/10 dark:text-orange-400">
          {jobs.length} Items
        </span>
      </div>
        ...
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="border-b border-zinc-100 dark:border-zinc-800">
              <th className="py-3 pl-0 pr-4 text-[10px] font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-400">
                Issue
              </th>
              <th className="px-4 py-3 text-[10px] font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-400">
                Correction
              </th>
              <th className="px-4 py-3 text-right text-[10px] font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-400">
                Timestamp
              </th>
            </tr>
          </thead>
