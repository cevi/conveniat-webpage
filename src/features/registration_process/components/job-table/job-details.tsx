 ...
 */
const InputViewer: React.FC<{ data: unknown }> = ({ data }) => {
        ...
        parsedData !== undefined && parsedData !== null ? (
          <div className="mt-2 text-xs">
            ...
            <div className="relative">
              ...
              <JsonBlock
                data={parsedData}
                className="border-red-100 bg-red-50/50 text-red-700 dark:border-red-900/30 dark:bg-red-950/10 dark:text-red-300"
              />
            </div>
          </div>
        ) : (
    ...
    <div className="grid grid-cols-1 divide-x divide-zinc-100 lg:grid-cols-[320px_1fr] dark:divide-zinc-800">
      ...
      <div className="flex flex-col gap-6 p-6">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Job Details</h3>
          <Badge
                        ...
                        {candidates.map((candidate) => (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                void handleResolve({ resolvedUserId: candidate.personId })
                              }
                    ...
                    <div className="flex flex-col gap-4 rounded-lg border border-orange-100/50 bg-orange-50/30 p-4 dark:border-orange-900/20 dark:bg-orange-950/20">
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() => void handleResolve({ resolvedUserId: manualPersonId })}
                      ...
                      <div className="grid gap-2 border-t border-orange-100/50 pt-3 sm:grid-cols-2 dark:border-orange-900/20">
                        <button
                          type="button"
                          onClick={() => void handleResolve({ forceCreateUser: true })}
                          disabled={isResolving}
